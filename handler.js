...
global.dfail = (type, m, conn) => {
	const msg = {
    // Permission messages
    rowner: '🚫 *This command is reserved for the bot developer only*',
    owner: '🔒 *This command is restricted to bot owners only*',
    mods: '👮 *Only moderators can use this command*',
    premium: '💎 *Premium feature - upgrade to use this command*',
    group: '👥 *This command only works in groups*',
    private: '🔐 *Please use this command in private chat*',
    admin: '🛡️ *Only group admins can use this command*',
    botAdmin: '🤖 *I need to be admin to perform this action*',
    nsfw: '🔞 *NSFW mode must be enabled for this content*',
		game: '🎮 *This command is only available in game mode*',
    unreg: `📝 Please register to use this feature:\n\n*#register yourname.age*\n\nExample: *#register Terrizev.18*`,
    restrict: '⛔ *This feature is currently disabled*',
	}[type]
